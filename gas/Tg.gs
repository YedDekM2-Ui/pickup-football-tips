...
var TG_MENU_ =
  ...
  '/สรุป — กำไรขาดทุนสะสม\n' +
  '/ทีเด็ด — ทีเด็ดที่ผ่านเกณฑ์ เรียงตามมั่นใจสุด\n' +
  '/คู่ — คู่ที่ยังไม่เตะ\n' +
...
var TG_CMDS_ = [
  { command: 'help',         thai: '/เมนู',        desc: 'เมนูคำสั่งทั้งหมด' },
  { command: 'picktips',     thai: '/ทีเด็ด',      desc: 'ทีเด็ดที่ผ่านเกณฑ์' },
  ...
  { command: 'fvstat',       thai: '/สถิติค่าคุ้ม',   desc: 'ความแม่นใบค่าคุ้มก่อนเกม' },
  { command: 'f5stat',       thai: '/สถิติเตือน',    desc: 'ความแม่นใบเตือนบอลสด FABEL5' },
  { command: 'fbstat',       thai: '/สถิติบอล',     desc: 'ความแม่นทีเด็ด FootballTips' },
