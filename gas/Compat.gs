...
function cfgStat_() {
  ...
  /* โหมดรับข้อความ (ดึงเอง/webhook) ไม่ใช่ความลับ แต่เป็นตัวชี้เป็นชี้ตายของงานอัตโนมัติ
     ไม่โชว์ไว้ตรงนี้ เวลาบอทเงียบจะไล่ไม่ถูกว่าโหมดมันเปลี่ยนไปหรือเปล่า */
  try { o['TG_MODE'] = tgMode_(); } catch (e) { o['TG_MODE'] = '?'; }
